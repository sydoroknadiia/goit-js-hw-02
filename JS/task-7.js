...
const MS_LOGIN_ADD = "Логин успешно добавлен!"
const MS_CANCEL = "Такой логин уже используется!"
const MS_ERROR = "Ошибка! Логин должен быть от 4 до 16 символов"
...
const addLogin = function(allLogins, login) {
  if (isLoginValid(login) === false) {
    console.log(MS_ERROR);
  } else if(isLoginUnique(allLogins, login) === true) {
    logins.push(login);
    console.log(MS_LOGIN_ADD);
} else {
    console.log(MS_CANCEL); 
}
};
